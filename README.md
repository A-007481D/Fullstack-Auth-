...
Branch history:
- `feature/project-init` — repository structure, .gitignore, README skeleton
- `feature/docker-setup` — Dockerfiles, docker-compose, Nginx, supervisor, entrypoint
- `feature/frontend-auth` — complete Next.js frontend (all dashboards, auth, types)
